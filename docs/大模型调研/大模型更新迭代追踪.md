...
![](D:\NLP\zhangnn520.github.io\imgs\训练监督策略.png)
...
![](D:\NLP\zhangnn520.github.io\imgs\训练奖励模型.png)
...
![poo](D:\NLP\zhangnn520.github.io\imgs\poo.png)

## 二、ChatGPT的技术架构

​		ChatGPT之前有几个知名的兄弟，包括GPT-1、GPT-2和GPT-3。这几个兄弟一个比一个个头大，ChatGPT与GPT-3更为相近。

![chatgpt前世今生](D:\NLP\zhangnn520.github.io\imgs\chatgpt前世今生.png)
